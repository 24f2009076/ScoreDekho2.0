<template>
    ...
    <div class="body" @pointermove="handlePointerMove">
        ...
        <div class="card reveal">
            <div class="card-head">Hello!</div>
            <div class="card-text">Create your own account to get started</div>
            ...
            <div class="register-text">Already have an account? <a href="/login">Log in</a></div>
        </div>
    </div>
